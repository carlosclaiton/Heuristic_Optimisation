...
%%
save ('CG_QKP_run50_8to560','BudgetArray','ModeScore','gBest','gBestScore','CompMatrix',...
...
% end
for i=1:ind
    plot([0:NumbInitiative(i)+20],ones(NumbInitiative(i)+21)*OptAnalytical(i),'--r','linewidth',2);
end
hold off
box on;
grid on;
